...
const jsonData = {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    document.querySelector('.technical-project-management').textContent = jsonData.title;
    document.querySelector('.description-write-a-300400-word-article-from-your-thread-publish-your-understanding-and-showcase-your-understanding-to-the-entire-world').innerHTML = jsonData.description;
    document.querySelector('.explore-the-world-of-management').textContent = jsonData.tasks[0].task_title;
    document.querySelector('.as-aproject-manager-you-play-an-important-reole-in-leading-aproject-through-initiation-planning-execution-monitoring-controlling-and-completion-how-do-you-want-to-manage-each-and-every-step-of-your-life').textContent = jsonData.tasks[0].task_description;
    document.querySelector('.technical-project-management-1').textContent = jsonData.tasks[0].assets[0].asset_title;
    document.querySelector('.description-story-of-alignment-scope-of-agility-specific-accountable-staggering-approach').textContent = jsonData.tasks[0].assets[0].asset_description;
    document.querySelector('.threadbuild').textContent = jsonData.tasks[0].assets[1].asset_title;
    document.querySelector('.description-watch-the-video-and-threadbuild-and-jot-out-key-threads-while-watching-the-video').textContent = jsonData.tasks[0].assets[1].asset_description;
    document.querySelector('.structure-your-pointers').textContent = jsonData.tasks[0].assets[2].asset_title;
    document.querySelector('.description-write-a-300400-word-article-from-your-thread-publish-your-understanding-and-showcase-your-understanding-to-the-entire-world').textContent = jsonData.tasks[0].assets[2].asset_description;
    document.querySelector('.sa-method').textContent = jsonData.tasks[0].assets[3].asset_title;
    document.querySelector('.description-to-explore-more-read-more').textContent = jsonData.tasks[0].assets[3].asset_description;
  });
})